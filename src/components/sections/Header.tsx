        ...
        {drawerOpen && (
          <>
            <motion.aside
              ...
              animate="show"
              exit="exit"
              className="fixed inset-y-0 left-0 z-[999] w-[78%] max-w-sm bg-white shadow-xl"
            >
              ...
              <nav className="px-2 py-3 bg-white">
                {leftNav.map((item) => (
              ...
              <div className="mt-auto border-t px-4 py-3 text-sm bg-white">
                <a
                  href={phoneHref}
                  className="inline-flex items-centerw-full h-[380px] object-cover rounded-2xl gap-2 text-[#4F4640]/80 hover:text-[#4F4640]"
                >
