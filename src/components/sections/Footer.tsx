...
export default function Footer({
  ...
  return (
    <footer className={cn("bg-white text-[#4F4640] mt-10", className)}>
      {/* Top */}
      <motion.div
        variants={fadeUp}
        initial="hidden"
        ...
        className="container-xl mx-auto py-10 md:py-12"
      >
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          ...
          <img src={footerLogo} alt="footer logo"></img>
            ...
            <p className="mt-4 text-base leading-6 text-[#000]/50">
              {brand.tagline}
            </p>
            ...
            <nav className="mt-4 space-y-3 text-sm">
              {quickLinks.map((l) => (
                <a
                  key={l.label}
                  href={l.href}
                  className="block text-base text-[#000000]/70 hover:text-[#FF7020]"
                >
                  {l.label}
                </a>
              ))}
          ...
          <div className="md:col-span-3">
            ...
            <p className="mt-4 text-sm text-[#000]">{contact.blurb}</p>

         <div className="flex justify-between">
            <div className="mt-4 flex items-start gap-3">
              {/* headset icon */}
            <FaHeadset className="w-12 h-12 text-[#8D8D8D]"/>

              <div>
                <div className="text-xs text-zinc-500">Have any question?</div>
                <a
                  href={`tel:${contact.phone.replace(/[^0-9+]/g, "")}`}
                  className="text-base font-semibold text-[#FF7020]"
                >
                  {contact.phone}
                </a>
              </div>
            ...
            <a
              ...
              style={{borderRadius:"12px"}}
              className="mt-4 inline-flex text-sm items-center justify-center  border border-blue-200 px-4 py-2  font-semibold text-[#3D7BD8] hover:bg-blue-50"
            >
              LIVE CHAT
            </a>
          </div>
      ...
      {/* Bottom strip */}
      <div className="container-xl mx-auto flex flex-col items-start gap-4 py-6 text-base text-[#5C5C5C] md:flex-row md:items-center md:justify-between">
