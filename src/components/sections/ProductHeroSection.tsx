...
import bgImages from "../../../public/assets/hero/hero-image.png"
...
export default function ProductHeroSection({
  ...
  return (
    <section className="relative isolate container-xl mx-auto rounded-2xl overflow-hidden mt-7 shadow-lg">
      ...
      {/* 🔹 Main Content */}
      <div className="relative z-10 text-center py-20 sm:py-28 lg:py-24 flex flex-col items-center justify-center">
        {/* ▶️ Play Button */}
        <motion.button
          variants={fadeInUp}
          initial="hidden"
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center justify-center bg-white/20 backdrop-blur-md w-16 h-16 rounded-full border border-white/50 shadow-lg mb-6"
        >
        ...
        {subtitle && (
          ...
          >
            Ako ti je svejedno kakav nož koristiš - ovaj video nije za vas!
          </motion.p>
        )}
