  ...
  return (
    <div className="text-[#2b1d13]">
      ...
      <div className="border-b border-gray-200">
        ...
        >
          <span className=" text-[#4F4640] md:text-xl text-lg">Description</span>
          <ChevronUp
      ...
      <div className="border-b border-gray-200">
        <button
          ...
          className="w-full flex items-center justify-between py-3 text-[15px] font-semibold text-[#2b1d13] hover:text-[#2b1d13]/80"
        >
          <span className="md:text-xl text-lg">Specifications</span>
          <ChevronUp
            className={`h-4 w-4 transition-transform duration-300 ${
      ...
      <div className="border-b border-gray-200">
        <button
          ...
          className="w-full flex items-center justify-between py-3 text-[15px] font-semibold text-[#2b1d13] hover:text-[#2b1d13]/80"
        >
          <span className=" text-[#4F4640] md:text-xl text-lg">Shipping & Returns</span>
          <ChevronUp
            className={`h-4 w-4 transition-transform duration-300 ${
