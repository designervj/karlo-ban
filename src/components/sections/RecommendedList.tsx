...
export default function RecommendedList({ items }: { items: Rec[] }) {
  return (
    <section className="md:container-xl sm:container-xl py-0 px-0">
      <h3 className="mb-8 text-xl font-semibold">Recommended next to this product:</h3>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-1">
        {items.map((r) => (
         <Card key={r.id} className="grid grid-cols-1 md:grid-cols-2 overflow-hidden">
  {/* Left side - Image */}
  ...
  <div className="flex flex-col justify-between">
    ...
    <CardFooter className="flex items-center justify-between">
      ...
      <div>
        <div className="md:text-2xl text-xl font-semibold text-[var(--brand-orange)]">
