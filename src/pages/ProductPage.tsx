...
import RecommendedList from "@/components/sections/RecommendedList";
        ...
        <div className="space-y-6">
          ...
          <ProductSpecs
            ...
            specs={[
              ...
              { label: "Knife use", value: "All purposes – except bone cutting" },
            ]}
        ...
        items={[
          {
            ...
            name: "Wooden Box",
            priceEUR: 45,
            image: "/assets/Image/category-img-2.png",
          ...
          },
          {
            ...
            name: "Hoodie",
            priceEUR: 65,
            image: "/assets/Image/category-img.png",
            blurb: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.",
          },
        ]}
      />
